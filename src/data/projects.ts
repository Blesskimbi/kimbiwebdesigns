...
export const staticProjects: StaticProject[] = [
    ...
    },
    {
        ...
        description: "TechFlow is a data-driven SaaS analytics dashboard that helps businesses visualise growth metrics, track user behaviour, and generate actionable reports. The interface was designed for clarity and speed, with real-time data visualisation, customisable widget panels, and a dark-mode-first design language.",
        category: "Web Design",
